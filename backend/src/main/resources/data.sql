...
INSERT INTO tb_address(street, number, district, complement) VALUES ('Rua Alfazema', '91', 'Sta Terezinha', 'Casa');
INSERT INTO tb_phone(number, type) VALUES ('999999999', 1);

INSERT INTO tb_client(name, cpf, client_status, address_id, phone_id) VALUES('Maria Joaquina', '08298774145', 1, 1, 1);

INSERT INTO tb_order (order_status, receiver, shipper, address_receiver_id, client_id, phone_receiver_id, created_at, updated_at) VALUES (2, 'Camila', 'Maycon', 1, 1, 1, TIMESTAMP WITH TIME ZONE '2020-07-14T10:00:00Z', TIMESTAMP WITH TIME ZONE '2020-07-14T10:00:00Z');
